...
public class PdfExportSavingService {
    ...
    public byte[] generateReport(String pdf) {
        ...
        try {
            ...
            return reportStrategy.generateReportPayroll(informationDataMapAssigment, initStorageBucket, templateName.split(", "));
    ...
    public void getDetailMapNomina(Map<String, Object> parameters) {
        ...
        List<ListDetailWithholdingDTO> tableDataList = Data.detailHoldingPDF();
